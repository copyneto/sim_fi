...
@EndUserText.label: 'Status de recusa (todos os itens)'
...
define view entity ZI_FI_VH_OVERALLSDDOCREJSTS
                                  ...
                                  and Text.ddlanguage = $session.system_language
{
  ...
  key cast( Objeto.domvalue_l as abstk ) as OverallSDDocumentRejectionSts, 

      @Semantics.text: true
      @UI.lineItem: [{ position: 20 }]
      Text.ddtext                        as OvrlSDDocumentRejectionStsDesc
}
where
  Objeto.domname = 'STATV'
