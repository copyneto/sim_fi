@AbapCatalog.sqlViewName: 'ZVFIDCFATALL'
@AbapCatalog.compiler.compareFilter: true
@AbapCatalog.preserveKey: true
@AccessControl.authorizationCheck: #NOT_REQUIRED
@EndUserText.label: 'Busca faturas FIDC'
define view ZI_FI_FIDC_FATURAS_DADOS
  as select distinct from bseg             as Fat

    inner join            bkpf             as _Head   on  Fat.belnr = _Head.belnr
                                                      and Fat.bukrs = _Head.bukrs
                                                      and Fat.gjahr = _Head.gjahr
