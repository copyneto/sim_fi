@AbapCatalog.sqlViewName: 'ZVFIDCFAT'
@AbapCatalog.compiler.compareFilter: true
@AbapCatalog.preserveKey: true
@AccessControl.authorizationCheck: #NOT_REQUIRED
@EndUserText.label: 'Busca faturas para envio'
define view ZI_FIDC_FATURAS_ENVIO
  as select distinct from bsid                         as Fat
    ...
    inner join            I_AddlCompanyCodeInformation as _AddlCompany on  _AddlCompany.CompanyCode              = Fat.bukrs
                                                                       and _AddlCompany.CompanyCodeParameterType = 'J_1BBR'

    inner join            I_Branch                     as _MainBranch  on  _MainBranch.CompanyCode = Fat.bukrs
                                                                       and _MainBranch.Branch      = _AddlCompany.CompanyCodeParameterValue
...

{
  ...
  key Fat.buzei,
      ...
      Fat.wrbtr,
      Fat.budat,
      _MainBranch.TaxNumber1              as CNPJEmissor,
